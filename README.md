...
### Setup Adapter
You will need to set up the appropriate adapter for your cache. So far, there is only support for Redis. If you would like to see additional Adapters added, please open an issue or, better yet, a pull request with an implementation.
